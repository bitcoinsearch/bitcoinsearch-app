  ...
  return (
    <div className="flex md:flex-row items-start p-2 xl:p-3 2xl:p-5 gap-2 xl:gap-5 max-w-lg xl:max-w-xl 2xl:max-w-2xl md:items-start border rounded-md xl:rounded-2xl border-custom-stroke">
      ...
      <div className="flex flex-col gap-1 lg:gap-1.5">
        <h3 className="text-[12px] lg:text-lg 2xl:text-2xl font-bold text-custom-primary-text">
        ...
        <a
          ...
          className="mt-4 text-custom-white rounded-md lg:rounded-[10px] p-1.5 lg:p-3 hover:bg-custom-accent cursor-pointer bg-custom-black max-w-[max-content] text-[10px] lg:text-sm"
        >
