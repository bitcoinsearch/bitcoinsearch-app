              ...
              <div className="flex-col relative w-full">
                ...
                >
                  <input
                    ...
                    className="text-custom-primary-text dark:text-custom-secondary-text search-box py-1.5 md:py-3 md:text-base placeholder:text-xs md:placeholder:text-base h-full placeholder:text-custom-stroke w-full border-none outline-none bg-transparent "
                  />
                  {isShortcutVisible && (
